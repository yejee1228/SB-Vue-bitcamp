    ...
    <form action="MemberJoinProc.jsp" method="post">
        <table class="table table-boardered">
            ...
            <tr>
                <th>당신의 피부타입</th>
                <td>
                <input type="checkbox"  name="skinType" value="건성">건성 &nbsp;&nbsp;
                <input type="checkbox"  name="skinType" value="지성">지성 &nbsp;&nbsp;
                <input type="checkbox"  name="skinType" value="복합성">복합성 &nbsp;&nbsp;
                <input type="checkbox"  name="skinType" value="민감성">민감성 &nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <th>당신의 직업은</th>
