...
import MyPage from "@/components/MyPageRPM.vue"
...
import FindedStudent from '@/components/student/FindedStudent'
...
export default new Router({
	...
	routes : [
		...
		{path:'/findedStudent', name : 'findedStudent', component : FindedStudent}
	]
})
